...
(function () {
  ...
  proto.addTouchEvents = function () {
    ...
    Event.on(window, 'touchmove', function (e) {
      ...
      if (that.touch_x > 0 || that.touch_x < (that.pages.length - 1) * -width) {
  ...
  proto.drawNextPrev = function () {
    ...
    this.prev_insensitive.appendChild(document.createTextNode(this.text_prev));
    ...
    this.next_insensitive.appendChild(document.createTextNode(this.text_next));
