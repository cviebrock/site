...
SiteCommentDisplay.prototype.initControls = function () {
  ...
  YAHOO.util.Event.on(this.approve_button, 'click', this.publish, this, true);

  this.deny_button = document.createElement('input');
  this.deny_button.type = 'button';
  this.deny_button.value = this.getDenyButtonText();
  YAHOO.util.Event.on(this.deny_button, 'click', this.unpublish, this, true);
...
SiteCommentDisplay.prototype.initConfirmation = function () {
  ...
  SiteCommentDisplay.setTextContent(
    message_div,
...
SiteCommentDisplay.prototype.publish = function () {
  ...
  SiteCommentDisplay.xml_rpc_client.callProcedure(
    'publish',
    callBack,
    [this.comment_id],
    ['int']
...
SiteCommentDisplay.prototype.hideActions = function () {
  ...
  this.actions_animation.onComplete.subscribe(
    function () {
